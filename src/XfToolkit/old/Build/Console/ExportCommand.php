...
class ExportCommand extends Command {
	...
	public function fire()
	{
		...
		if ($hardLinks AND $lib = $this->argument('library'))
		{
			// TODO: info
	...
	protected function getArguments()
	{
		return array(
			...
			array('library', InputArgument::OPTIONAL, ''),
		);
	}
	...
	{
		return array(
			array('hard-links', null, InputOption::VALUE_NONE, 'If we are copying things back instead of symlinking', null)
		);
	}
}
